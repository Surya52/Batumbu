...
public class ValidusSmoke_CompanyIncorporateInSingapore extends BaseClass_Web{
  ...
  public void f(String no) throws Throwable {
	...
	//  salesforceComponent.mailTriggering();
	 ...
	 smokeComponent.CreateAccount();
	  ...
	  investorComponents.navigateTocompanyIncorporateInSingapore();
	  investorComponents.companyIncorporatedInSingapore();
	  salesforceComponent.salesforceApproval();
	 // investorComponents.login();
	 // investorComponents.Investorfund();
	  /*  salesforceComponent.salesforcefund();*/
