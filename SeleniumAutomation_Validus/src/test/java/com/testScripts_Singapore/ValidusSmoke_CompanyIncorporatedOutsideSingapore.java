...
public class ValidusSmoke_CompanyIncorporatedOutsideSingapore extends BaseClass_Web{
	  ...
	  investorComponents.openURL();
		 smokeComponent.CreateAccount();
		  ...
		  salesforceComponent.singaporeSalesforceOTP();
		   ...
		   investorComponents.navigateTocompanyIncorporateOutsideSingapore();
		   investorComponents.companyIncorporatedOutsideSingapore();
