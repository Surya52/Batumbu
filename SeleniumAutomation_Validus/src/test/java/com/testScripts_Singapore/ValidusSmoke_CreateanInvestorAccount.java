...
public class ValidusSmoke_CreateanInvestorAccount extends BaseClass_Web{
	public ValidusSmoke_Components loginComponents =new ValidusSmoke_Components(pdfResultReport); 
