...
public class ValidusSmoke_SMEInvoicefinancingCorporateVendorFinancing extends BaseClass_Web{
  ...
  public void f(String no) throws Exception {
	  ...
	  initializeRepository();
	   ...
	   loginComponents.registeringasSME();*/
	   loginComponents.invoiceFinancingCorporateVendorFinancingSME();
  }
}
