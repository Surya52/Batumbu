...
public class ValidusSmoke_IndividualInvestorSingaporeCitizen extends BaseClass_Web{
	  ...
	  investorComponents.openURL();
		 smokeComponent.CreateAccount();
		  ...
		  salesforceComponent.singaporeSalesforceOTP();
		   ...
		   investorComponents.navigateToindividualInvestorSingaporeCitizen();
		   investorComponents.individualInvestorSingaporeCitizen();
