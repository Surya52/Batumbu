...
public class BaseClass_iOS {
	...
	public void setWithText(String locator, String data) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().text(\""+locator+"\")").clear();
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().text(\""+locator+"\")").sendKeys(data);
	...
	public void setWithTextAndIndex(String locator, int no,String data) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().text(\""+locator+"\").instance("+no+")").clear();
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().text(\""+locator+"\").instance("+no+")").sendKeys(data);
		} catch (RuntimeException localRuntimeException) {
	...
	public void setWithResourceId(String locator, String data) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().resourceId(\""+locator+"\")").clear();
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().resourceId(\""+locator+"\")").sendKeys(data);
		} catch (RuntimeException localRuntimeException) {
			System.out.println("Error in entering the text in element:" + localRuntimeException.getMessage() + "Fail");
			pdfResultReport.addStepDetails("Enter Text", "Text Element should be enabled", "Error in entering the text in element: " + localRuntimeException.getMessage(), "FAIL","N");
			throw new AutomationException("Error in entering the text in element: " + localRuntimeException.getMessage());
	...
	public void setWithResourceIdAndIndex(String locator, int no, String data) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().resourceId(\""+locator+"\").instance("+no+")").clear();
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().resourceId(\""+locator+"\").instance("+no+")").sendKeys(data);
		} catch (RuntimeException localRuntimeException) {
			pdfResultReport.addStepDetails("findByText method", "Mobile Should find the Element", "Error in finding the element in mobile:" + localRuntimeException.getMessage(), "FAIL","N");
			throw new AutomationException("Error in finding the element in mobile" + localRuntimeException.getMessage());
		}
	...
	public void setWithClassName(String locator, String data) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().className(\""+locator+"\")").clear();
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().className(\""+locator+"\")").sendKeys(data);
		} catch (RuntimeException localRuntimeException) {
			System.out.println("Error in entering the text in element:" + localRuntimeException.getMessage() + "Fail");
			pdfResultReport.addStepDetails("Enter Text", "Text Element should be enabled", "Error in entering the text in element: " + localRuntimeException.getMessage(), "FAIL","N");
			throw new AutomationException("Error in entering the text in element: " + localRuntimeException.getMessage());
	...
	public void setWithClassNameAndIndex(String locator,int no, String data) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().className(\""+locator+"\").instance("+no+")").clear();
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().className(\""+locator+"\")").sendKeys(data);
		} catch (RuntimeException localRuntimeException) {
			System.out.println("Error in entering the text in element:" + localRuntimeException.getMessage() + "Fail");
			pdfResultReport.addStepDetails("Enter Text", "Text Element should be enabled", "Error in entering the text in element: " + localRuntimeException.getMessage(), "FAIL","N");
	...
	public void clickByText(String locator) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().text(\""+locator+"\")").click();
		} catch (RuntimeException localRuntimeException) {
			pdfResultReport.addStepDetails("findByText method", "Mobile Should find the Element", "Error in finding the element in mobile:" + localRuntimeException.getMessage(), "FAIL","N");
			throw new AutomationException("Error in finding the element in mobile" + localRuntimeException.getMessage());
		}
	...
	public void clickByTextWithIndex(String locator, int no) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().text(\""+locator+"\").instance("+no+")").click();
		} catch (RuntimeException localRuntimeException) {
			pdfResultReport.addStepDetails("findByText method", "Mobile Should find the Element", "Error in finding the element in mobile:" + localRuntimeException.getMessage(), "FAIL","N");
			throw new AutomationException("Error in finding the element in mobile" + localRuntimeException.getMessage());
		}
	...
	public void clickByResourceId(String locator) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().resourceId(\""+locator+"\")");
		} catch (RuntimeException localRuntimeException) {
			pdfResultReport.addStepDetails("findByText method", "Mobile Should find the Element", "Error in finding the element in mobile:" + localRuntimeException.getMessage(), "FAIL","N");
			throw new AutomationException("Error in finding the element in mobile" + localRuntimeException.getMessage());
		}
	...
	public void clickByResourceIdWithIndex(String locator, int no) throws Exception {
		try {
			ThreadLocaliOSDriver.getDriver().findElementByIosUIAutomation("UiSelector().resourceId(\""+locator+"\").instance("+no+")").click();
		} catch (RuntimeException localRuntimeException) {
			pdfResultReport.addStepDetails("findByText method", "Mobile Should find the Element", "Error in finding the element in mobile:" + localRuntimeException.getMessage(), "FAIL","N");
			throw new AutomationException("Error in finding the element in mobile" + localRuntimeException.getMessage());
		}
...
/*	public static void wait(int timer, WebElement elem) throws AutomationException{
	...
	public static int getRowNumber(String tableid, String colExpct,String rowExpct) throws AutomationException
	  ...
	  {	
		 ...
		 for (int i=1;i<=iRowCount;i++){
			intRowNumber++;
			WebElement getdata = ThreadLocaliOSDriver.getDriver().findElement(By.xpath("//table[@id='"+tableid+"']/tbody/tr["+i+"]/td["+getColNumber+"]"));
	...
	public static void VerifyTableElement(String[] value1,String[] value2){
		int n=0;
		List<WebElement> iRows = ThreadLocaliOSDriver.getDriver().findElements(By.xpath("//form[@name='frmFormView']/table/tbody/tr"));
		int iRowCount = iRows.size();
		for(int i=0;i<=iRowCount;i++){
			 WebElement getdata1 = ThreadLocaliOSDriver.getDriver().findElement(By.xpath("//form[@name='frmFormView']/table/tbody/tr["+i+"]/td[1]"));
			 WebElement getdata2 = ThreadLocaliOSDriver.getDriver().findElement(By.xpath("//form[@name='frmFormView']/table/tbody/tr["+i+"]/td[2]"));
	...
	public static void Mousehover(WebElement elem)
		  {
		    try
		    {
		      Actions action = new Actions(ThreadLocaliOSDriver.getDriver());
  ...
  {  
	...
	/*	try{
			excelReport.readTestDataFile(System.getProperty("user.dir")+"\\Resources\\TestData.xlsx",no);
