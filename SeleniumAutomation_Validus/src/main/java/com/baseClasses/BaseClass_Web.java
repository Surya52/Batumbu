...
/*	public void click(WebElement elem) throws Exception {
	...
	public  boolean js_Select(By by,String Text, String LocatorName) throws Throwable{
		boolean flag=true;
		try {
			WebElement location=ThreadLocalWebdriver.getDriver().findElement(by);
			...
			if (flag) {
				System.out.println("Select Data into "+LocatorName+ "Able to Select Data into :" + LocatorName);
			}
			else
			{
				System.out.println("Select Data into "+LocatorName+ "Able to Select Data into :" + LocatorName);
	...
	public void IsElementPresent(By locator) throws AutomationException {
		try {
			ThreadLocalWebdriver.getDriver().findElement(locator).isDisplayed();
	...
	public void afterSuite() throws Exception{
		try{
			...
			Sendmail.ComposeGmail("testingse2@gmail.com", "murthyvlabs@gmail.com", path);
